// Simple math game written by Gavin Weiss (Hasty) in Go
// Version 1 - February 2019
// Last edited January 24th, 2020
...
func game() {
	...
	HighNumberA := rand.Intn(50)
	HighNumberB := rand.Intn(50)

	ShortNumberA := rand.Intn(10)
	ShortNumberB := rand.Intn(10)

	AdditionAnswer := HighNumberA + HighNumberB
	SubtractionAnswer := HighNumberA - HighNumberB
	...
	*/
	...
	if RandomMathOperand == 0 {
		...
		fmt.Println("What is", HighNumberA, "+", HighNumberB, "?")
	}
